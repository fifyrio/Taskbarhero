      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-gray-700">
              ...
              Taskbar Hero provides the tools you need to transform your ideas into beautiful visuals.
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12 text-center">
          ...
          <p className="text-gray-700 max-w-4xl mx-auto mb-6">
            Founded with a vision to make AI-powered creativity accessible to everyone, Taskbar Hero 
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of creators who are already using Taskbar Hero
          </p>
