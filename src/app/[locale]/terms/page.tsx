          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                <a href="mailto:support@taskbarhero.wiki" className="text-yellow-600 hover:text-yellow-700 underline">
                  support@taskbarhero.wiki
                </a>{' '}
            ...
            <section>
              ...
              <p className="text-gray-700">
                If you have any questions about these terms, please contact us at <a href="mailto:support@taskbarhero.wiki" className="text-yellow-600 hover:text-yellow-700 underline">support@taskbarhero.wiki</a> or 
